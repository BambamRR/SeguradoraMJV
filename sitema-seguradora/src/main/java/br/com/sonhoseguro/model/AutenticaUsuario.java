...
public class AutenticaUsuario {
	//O campo login pode conter caracteres que representam cpf, telefone ou apelido com at� 
	//20 caracteres
	...
	public void cadastoLogin(Pessoa cadastro, String login, String password) {
